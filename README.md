...
```sh
yarn create astro@latest --template CodeStitchOfficial/Intermediate-Astro-Decap-CMS
```

```sh
pnpm create astro@latest --template CodeStitchOfficial/Intermediate-Astro-Decap-CMS
```
